			      ...
			      <div class="col s12 m4">
			      	...
			      	<form action="/content/scene/addscene/" method="post" id="addsceneform">
						...
						<div class="row margin">
							<div class="input-field col s12">
					            <input 
					            	placeholder="<?php echo $this->Lang->write('content_scene_label_book_isbn');?>" 
					            	type="text" id="isbn" 
					            	name="isbn" 
					            	value="<?php if(isset($post['isbn'])) { echo htmlspecialchars($post['isbn'], ENT_QUOTES, 'UTF-8'); }?>" 
					            />
					            
					            <label for="isbn" class="center-align"><?php echo $this->Lang->write('content_scene_label_book_isbn');?></label>
					            <div class="valerror"></div>
							</div>
						</div>
